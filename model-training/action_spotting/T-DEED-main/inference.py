...
def get_args():
    ...
    parser.add_argument('--output_dir', type=str, default='inference_output', help='Output directory for inference json')
    parser.add_argument('--output_filename', type=str, default='results_inference.json', help='Output JSON filename')
