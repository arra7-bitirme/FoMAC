...
from util.io import store_json, store_json_sn, store_json_snb, store_json_inference
...
def inference(model, inference_loader, classes, threshold=0.5, output_dir='inference_output', output_filename='results_inference.json'):
    ...
    print('Storing predictions with SNMS')
    store_json_inference(output_dir, pred_events_high_recall_store[0], stride = stride, filename = output_filename)